...
plugin%2Freleases%2Ftag%2F0.0.8)
...
Public
  ...
  * [ Code ](/almonit/almonit-plugin/tree/0.0.8)
...
More
  ...
  * [ Insights ](/almonit/almonit-plugin/pulse)
  ...
  2. [ 0.0.8 ](/almonit/almonit-plugin/releases/tag/0.0.8)
...
# Almonit Plugin v0.0.8

![@mdtanrikulu](https://avatars.githubusercontent.com/u/2774845?s=40&v=4)
[mdtanrikulu](/mdtanrikulu) released this

* [ 74 commits ](/almonit/almonit-plugin/compare/0.0.8...master) to master since this release 

[ 0.0.8  ](/almonit/almonit-plugin/tree/0.0.8)

[ `d893922` ](/almonit/almonit-
plugin/commit/d8939222bce6b16852a6cefc70d00ab85710df44)
...
### Changelog:
  ...
  * new logo/brand
  * privacy-preserving updates of default settings using ENS + IPFS

### Assets

3

  * [ almonit-0.0.8.zip ](/almonit/almonit-plugin/releases/download/0.0.8/almonit-0.0.8.zip)

564 KB

  * [ Source code (zip) ](/almonit/almonit-plugin/archive/refs/tags/0.0.8.zip)

  * [ Source code (tar.gz) ](/almonit/almonit-plugin/archive/refs/tags/0.0.8.tar.gz)
