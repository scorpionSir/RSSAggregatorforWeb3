...
3 - Economic Bandwidth
  ...
  * [__](https://open.spotify.com/show/41TNnXSv5ExcQSzEGLlGhy "Listen on Spotify")
  ...
  2. 3 - Economic Bandwidth

## [3 - Economic Bandwidth](https://sites.libsyn.com/247424/economic-
bandwidth)
...
While the internet revolution is all about data, the crypto revolution is all
about value. Scaling the internet is all about scaling data bandwidth, but
scaling crypto is all about economic bandwidth.

Join Ryan and David as they explore the concept of economic bandwidth and how
it relates to crypto-systems.

Links mentioned in podcast:

  * (Article) [ Ethereum is an emergent structure](https://bankless.substack.com/p/ethereum-is-an-emergent-structure)
  * (Article) [ ETH and BTC are economic bandwidth](https://bankless.substack.com/p/eth-and-btc-are-economic-bandwidth)
  * (Article) [The trillion dollar case for ETH](https://bankless.substack.com/p/the-trillion-dollar-case-for-eth)
  * (Article) [ETH is irreplaceable](https://bankless.substack.com/p/eth-is-irreplaceable)
  * (Dashboard) [ Economic Bandwidth metrics](https://messari.io/screener/economic-bandwidth-\(bankless\)-7A203FEF)
...
Tools from our sponsors to go bankless:
  ...
  * [Ethereal Summit](https://www.etherealsummit.com/) \- the most bankless crypto conference yet

\-----  
Episode Actions:

  1. Subscribe to [this podcast](http://podcast.banklesshq.com/)
  2. Subscribe to [Bankless newsletter program](https://bankless.substack.com/)
  3. Read the links above mentioned in podcast
...
[YouTube](https://www.youtube.com/watch?v=VRdCtNEKcHE) | [RSS
...
[YouTube](https://www.youtube.com/channel/UCAl9Ld79qaZxp9JzEOwd3aA)
